...
export async function PATCH(req: any): Promise<any> {
    try {
        ...
        const existingRecord = await prisma.notifikasimahasiswa.findUnique({
            where: { id },
        });
        ...
        const updatedNotifikasiMahasiswa = await prisma.notifikasimahasiswa.update({
            where: { id },
            data: { read: true },
        });
        ...
        const responsePayload = {
            ...
            data: updatedNotifikasiMahasiswa,
        };
